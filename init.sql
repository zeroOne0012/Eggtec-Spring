...
insert into recipe(idx, nickname, type, weight, selected) values(1,'nick', 'type', 'weight', true);
insert into history (recipe_no, item_no, lane1) values(1, 1, 0);
insert into setting(title) values('test');